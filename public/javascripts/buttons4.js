...
function mark_item_onclick_multyple_answers ( item_class, item_class_to_set, current_tick_class, tick_class_to_set){
...
// отмечаем скрытые инпуты по нажанию на блок
    mark_item_onclick_multyple_answers("answer-item-lg", "answer-item-lg-grey", "tick-hidden", "tick-shown");
// проверяем, нажат ли хоть один инпут и разблокирем кнопку, если да
    unlock_next_if_one_input_checked ("arrow-btn", "arrow-btn-disabled", "answer-item-lg");
// если необходимо - скрываем или показываем поля в "Другом"
    other_field_show_or_hide ("answer-item-lg", "answer-num-grey", "input-other");
...
// ставим галочки и окрашиваем те блоки, инпуты которых выбраны
    ...
    put_mark_if_input_checked("input", "answer-item-lg", "answer-item-lg-grey", "tick-hidden", 'tick-shown');
